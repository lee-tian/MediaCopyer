...
### `scripts/build/`
- **Function**: Build related scripts
- **Contains**: Application packaging, DMG creation scripts

### `scripts/release/`
- **Function**: Release related scripts
- **Contains**: Version release, GitHub Release creation scripts

### `scripts/debug/`
- **Function**: Debug related scripts
- **Contains**: Release debugging, test scripts

### `scripts/utils/`
- **Function**: General utility scripts
- **Contains**: Version management, Make scripts

### `scripts/platform/`
- **Function**: Platform-specific scripts
- **Contains**: Shell scripts, batch files
...
### `config/`
- **Function**: Configuration files directory
- **Contains**: PyInstaller configuration files

### `docs/`
- **Function**: Documentation directory
- **Contains**: Project documentation, user guides

### `tools/`
- **Function**: Development tools directory
- **Contains**: Icon generation, format conversion tools

### `resources/`
- **Function**: Application resource directory
- **Contains**: Icon files, image resources
