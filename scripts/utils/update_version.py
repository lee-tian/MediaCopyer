...
def show_help():
    ...
    print()
    print("用法:")
    print("  python scripts/utils/update_version.py <新版本号> [更新内容...]")
    print()
    print("参数:")
    ...
    print()
    print("示例:")
    print("  python scripts/utils/update_version.py 1.1.0")
    print("  python scripts/utils/update_version.py 1.1.0 '修复了重复文件处理bug'")
    print("  python scripts/utils/update_version.py 1.2.0 '添加忽略重复文件选项' '增强了复制操作分析'")
    print()
    print("选项:")
